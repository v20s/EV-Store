  ...
  return (
    <AppBar position="static" sx={{ backgroundColor: "#1976d2", padding: "5px 15px" }}>
      <Toolbar sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        {/* Left: Home Icon + Brand Name */}
        <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
          <IconButton
            onClick={() => navigate("/vehiclefilter")}
            sx={{
              color: "#fff",
              borderRadius: "50%",
          ...
          <Typography variant="h6" sx={{ fontWeight: 500, fontFamily: "monospace" }}>
            EV Store
          </Typography>
        </Box>
        ...
        <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
          ...
          <Box ref={dropdownRef} sx={{ position: "relative" }}>
            ...
            {dropdownOpen && (
              ...
              >
                <List>
                  <ListItem button onClick={() => navigate("/personal-info")}>
                  ...
                  <Divider />
                  <ListItem button onClick={handleLogoutAndRedirect} sx={{ color: "red" }}>
  ...
  return (
    <AppBar position="static" sx={{ backgroundColor: "#1976d2", padding: "5px 15px" }}>
      <Toolbar sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        {/* Right: Admin Dashboard, Cart, Profile */}
        <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
          ...
          >
            <DashboardIcon /> {/* Admin Dashboard Icon */}
          </IconButton>
