...
const VehicleFilter = () => {
  ...
  const paintOptions = [
    { name: "White", img: whiteImg },
    { name: "Black", img: blackImg },
    { name: "Blue", img: blueImg },
    { name: "Dark Gray", img: creamImg },
                  ...
                  <img
                    src={
                      hoveredVehicleId === vehicle.vehicleId
                        ? getInteriorImage(vehicle.interior) // Only show interior image if hovered
                        : vehicle.cover_image // Show cover image otherwise
                    }
                    alt={vehicle.model}
                    className="vehicle-image"
                    onMouseEnter={() => {
                      console.log(`Hovering over vehicle ${vehicle.vehicleId} with ${vehicle.interior}`); // Debugging
                      setHoveredVehicleId(vehicle.vehicleId);
                    }}
                    onMouseLeave={() => {
                      console.log(`Left vehicle ${vehicle.vehicleId}`); // Debugging
